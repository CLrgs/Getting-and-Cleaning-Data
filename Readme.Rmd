...
The dataframe has 2 collumns: the 1st with the Nr. of variable/feature (i.e.: V1, V2 etc) and the 2nd with the full name of the variable/feature (i.e.: . There are 86 such variables(rows) in the dataframe.
2.b) choose from "data" (created in previous step Nr.2) the  first two collumns (= "Subjects" + "Activity") plus all collumns matching the previous vector (features1$V1) and pass them to a new data frame : "data1"
